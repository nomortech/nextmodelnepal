...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div id="drawer-navigation" className={`fixed top-0 left-0 z-40 w-full h-full p-4 overflow-y-auto transition-transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"} bg-gray-800 dark:bg-gray-800`} tabIndex={-1} aria-labelledby="drawer-navigation-label">
