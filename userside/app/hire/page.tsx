                ...
                <div className="form flex-1 flex flex-col flex-wrap items-center gap-3">
                    ...
                    <div className="flex gap-2 items-center">
                        <div className="relative min-w-[20vw]">
                            ...
                            <input type="date" className="bg-transparent border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" />
                        </div>
