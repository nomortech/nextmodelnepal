...
async function getEachData(id: string) {
  const res = await fetch(
...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  const eachEventData = await getEachData(params.slug);
  ...
  return (
    <Events events={events} eachEventData={eachEventData} params={params.slug} />
